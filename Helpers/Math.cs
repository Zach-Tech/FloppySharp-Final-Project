...
namespace ZacharyChilders_Final_Project_CPT_185_FloppySharp.Helpers
{
    public static class  MathButCooler
    {
        ...
        public static double PerformComputation(String sentence)
        {
            ...
            catch (FormatException e) //eeeeeee
            {
                return 0;
            }
        ...
        private static void ReplaceSegment(List<String> list, int startIdx)
        {
            ...
            list.RemoveAt(startIdx);
            list[startIdx] = MathButCooler.PerformComputation(s).ToString(CultureInfo.CurrentCulture);
        }
